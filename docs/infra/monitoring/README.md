...
# Monitoring Docs Entry

This path is kept active for docs consistency.

The canonical monitoring guide is:
...
- [OBSERVABILITY_ACCESS.md](OBSERVABILITY_ACCESS.md)

## Policy

Keep implementation-level monitoring instructions in `../../monitoring/README.md`.
Keep topic-specific docs (logging/metrics/access) in this folder.
