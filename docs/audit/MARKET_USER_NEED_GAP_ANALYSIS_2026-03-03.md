...
- Public competitor positioning (Vyapar, myBillBook, Khatabook, Zoho Books, BUSY)
...
5. Migration + compliance exports (Tally-facing workflows)

If these are not closed, voice advantage alone may not be enough for conversion in high-volume retail.

---

## Competitor Reality Snapshot (public claims)

### Vyapar
- Strong claims on offline billing, GST reports (GSTR variants), reminders, inventory, backup, invoice formats
- Positioning around easy billing + inventory + GST + payment collection

### myBillBook
- Claims on fast GST billing, WhatsApp/SMS auto sharing, quotations/proforma, e-invoicing/e-way bill, Tally export, barcode/batch workflows
- Heavy SMB retail messaging around stock + collections + multi-device

### Khatabook
- Strong in digital bahi-khata, reminders, mobile-first usage, multi-business account handling
- Less complete accounting depth vs full accounting suites, but very strong habit product
...
|---|---|---|---|
| GST report export (GSTR-1 ready, HSN, B2B lists) | CA handoff and monthly filing trust | Strongly marketed by competitors | TODO |
| Date-range reports + CSV export | Owners want cashflow/P&L visibility, CA needs exports | Standard expectation | TODO |
| Barcode scan at billing | Speed for large SKU stores | Common in myBillBook/Vyapar class tools | TODO |
| Credit limit enforcement | Prevents bad debt growth | Standard in mature systems | TODO |
| Batch/expiry tracking | Mandatory for pharma/FMCG | Strong differentiator in competitors | TODO |
| Mixed-mode payment (cash+UPI split) | Real transaction behavior | Common expectation | TODO |
| Proforma/quotation | B2B order conversion workflow | Common in competitor stack | TODO |
| Delivery preference per customer (WA/email/both) | Better reminder conversion | Competitive parity | TODO |
...
| Tally/Vyapar import migration | Faster switching from incumbent tools | TODO |
...
- Tally/Vyapar import wizard (minimum viable migration)
...
- Public competitor marketing pages (feature claims, not audited implementations)

Use customer interviews + trial data to validate each competitor claim in field conditions.
