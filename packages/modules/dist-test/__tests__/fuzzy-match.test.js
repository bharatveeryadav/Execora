...
(0, node_test_1.default)('exact match: "Bharat" matches "Bharat"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Bharat', 'Bharat', 0.7) !== null);
});
...
(0, node_test_1.default)('phonetic: trailing-h variation "Bharat" matches "Bharath"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Bharat', 'Bharath', 0.7) !== null);
});
(0, node_test_1.default)('phonetic: vowel variation "Rahul" matches "Rahool"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Rahul', 'Rahool', 0.7) !== null);
});
(0, node_test_1.default)('phonetic: ee→i "Deepak" matches "Dipak"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Deepak', 'Dipak', 0.7) !== null);
});
(0, node_test_1.default)('phonetic: ee→i "Sandeep" matches "Sandip"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Sandeep', 'Sandip', 0.7) !== null);
});
(0, node_test_1.default)('phonetic: vowel variation "Suresh" matches "Sauresh"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Suresh', 'Sauresh', 0.7) !== null);
});
(0, node_test_1.default)('phonetic: trailing-a "Ganesh" matches "Ganesha"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Ganesh', 'Ganesha', 0.7) !== null);
});
(0, node_test_1.default)('aspirated: bh→b "Bharat" matches "Barat"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Bharat', 'Barat', 0.7) !== null);
});
(0, node_test_1.default)('aspirated + vowel: "Pritam" matches "Preetam"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Pritam', 'Preetam', 0.7) !== null);
});
(0, node_test_1.default)('aspirated: kh→k "Khatri" matches "Katri"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Khatri', 'Katri', 0.7) !== null);
});
(0, node_test_1.default)('nickname: "Raju" matches "Rahul"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Raju', 'Rahul', 0.7) !== null);
});
(0, node_test_1.default)('nickname: "Sonu" matches "Saurabh"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Sonu', 'Saurabh', 0.7) !== null);
});
(0, node_test_1.default)('nickname: "Abhi" matches "Abhishek"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Abhi', 'Abhishek', 0.7) !== null);
});
(0, node_test_1.default)('nickname: "Sandy" matches "Sandeep"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Sandy', 'Sandeep', 0.7) !== null);
});
(0, node_test_1.default)('nickname: "Vicky" matches "Vivek"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Vicky', 'Vivek', 0.7) !== null);
});
(0, node_test_1.default)('honorific: "Bharat" matches "Bharat Bhai"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Bharat', 'Bharat Bhai', 0.7) !== null);
});
(0, node_test_1.default)('honorific removal: "Suresh bhai" matches "Suresh"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Suresh bhai', 'Suresh', 0.7) !== null);
});
(0, node_test_1.default)('honorific: "Ramesh Ji" matches "Ramesh"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Ramesh Ji', 'Ramesh', 0.7) !== null);
});
(0, node_test_1.default)('V/W confusion: "Vikas" matches "Wikas"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Vikas', 'Wikas', 0.7) !== null);
});
(0, node_test_1.default)('V/W confusion: "Vijay" matches "Wijay"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Vijay', 'Wijay', 0.7) !== null);
});
(0, node_test_1.default)('transliteration: ksh→x "Lakshmi" matches "Laxmi"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Lakshmi', 'Laxmi', 0.7) !== null);
});
(0, node_test_1.default)('transliteration complex: "Srinivas" matches "Shreenivaas"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Srinivas', 'Shreenivaas', 0.7) !== null);
});
(0, node_test_1.default)('transliteration regional: "Krishna" matches "Kishan"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Krishna', 'Kishan', 0.7) !== null);
});
(0, node_test_1.default)('sibilant: sh→s "Ashok" matches "Asok"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Ashok', 'Asok', 0.7) !== null);
});
(0, node_test_1.default)('sibilant variation: "Prakash" matches "Prakas"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Prakash', 'Prakas', 0.7) !== null);
});
(0, node_test_1.default)('double consonant typo: "Ankit" matches "Ankitt"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Ankit', 'Ankitt', 0.7) !== null);
});
(0, node_test_1.default)('transposition typo: "Aditya" matches "Aditay"', () => {
    strict_1.default.ok((0, infrastructure_1.matchIndianName)('Aditya', 'Aditay', 0.7) !== null);
});
// ── matchIndianName — should NOT match ──────────────────────────────────────
(0, node_test_1.default)('no match: "Bharat" does not match "Rahul"', () => {
    strict_1.default.equal((0, infrastructure_1.matchIndianName)('Bharat', 'Rahul', 0.7), null);
});
(0, node_test_1.default)('no match: "Amit" does not match "Sumit"', () => {
    strict_1.default.equal((0, infrastructure_1.matchIndianName)('Amit', 'Sumit', 0.7), null);
});
(0, node_test_1.default)('no match: "Ram" does not match "Shyam"', () => {
    strict_1.default.equal((0, infrastructure_1.matchIndianName)('Ram', 'Shyam', 0.7), null);
});
// ── findBestMatch ────────────────────────────────────────────────────────────
...
(0, node_test_1.default)('findBestMatch: "Bharath" resolves to "Bharat" (first-name list)', () => {
    const match = (0, infrastructure_1.findBestMatch)('Bharath', FIRST_NAMES, 0.7);
...
(0, node_test_1.default)('findBestMatch: "Amitbhai" resolves to "Amit" via honorific stripping', () => {
    const match = (0, infrastructure_1.findBestMatch)('Amitbhai', FIRST_NAMES, 0.7);
    strict_1.default.ok(match !== null, 'should find a match');
...
(0, node_test_1.default)('findBestMatch: "Bharath" still matches in full-name list at lower threshold', () => {
    const match = (0, infrastructure_1.findBestMatch)('Bharath', FULL_NAMES, 0.5);
    strict_1.default.ok(match !== null, 'should find a match');
...
(0, node_test_1.default)('findBestMatch: returns null when no candidates meet the threshold', () => {
    const match = (0, infrastructure_1.findBestMatch)('Zephyr', FIRST_NAMES, 0.7);
    strict_1.default.equal(match, null);
});
// ── isSamePerson ─────────────────────────────────────────────────────────────
(0, node_test_1.default)('isSamePerson: "Bharat" and "Bharath" are the same', () => {
    strict_1.default.equal((0, infrastructure_1.isSamePerson)('Bharat', 'Bharath'), true);
});
(0, node_test_1.default)('isSamePerson: "Rahul" and "Raju" are the same', () => {
    strict_1.default.equal((0, infrastructure_1.isSamePerson)('Rahul', 'Raju'), true);
});
(0, node_test_1.default)('isSamePerson: "Saurabh" and "Sonu" are the same', () => {
    strict_1.default.equal((0, infrastructure_1.isSamePerson)('Saurabh', 'Sonu'), true);
});
(0, node_test_1.default)('isSamePerson: "Deepak" and "Dipak" are the same', () => {
    strict_1.default.equal((0, infrastructure_1.isSamePerson)('Deepak', 'Dipak'), true);
});
(0, node_test_1.default)('isSamePerson: "Amit" and "Sumit" are NOT the same', () => {
    strict_1.default.equal((0, infrastructure_1.isSamePerson)('Amit', 'Sumit'), false);
});
(0, node_test_1.default)('isSamePerson: "Ram" and "Shyam" are NOT the same', () => {
    strict_1.default.equal((0, infrastructure_1.isSamePerson)('Ram', 'Shyam'), false);
});
// ── findAllMatches ────────────────────────────────────────────────────────────
(0, node_test_1.default)('findAllMatches: "Raju" returns >=2 matches from Raj* names, sorted by score', () => {
    ...
    const matches = (0, infrastructure_1.findAllMatches)('Raju', candidates, 0.6);
...
(0, node_test_1.default)('findAllMatches: "Bharat" does not match completely different names', () => {
    const matches = (0, infrastructure_1.findAllMatches)('Bharat', ['Zephyr', 'Quintus', 'Xander'], 0.7);
