...
exports.TRANSLITERATE_PROMPT = exports.NORMALIZE_TRANSCRIPT_PROMPT = void 0;
exports.getLangStyle = getLangStyle;
exports.buildIntentSystemPrompt = buildIntentSystemPrompt;
exports.buildResponseSystemPrompt = buildResponseSystemPrompt;
/**
 ...
 */
function buildIntentSystemPrompt(conversationContext) {
 ...
 */
function buildResponseSystemPrompt(langStyle) {
...
exports.NORMALIZE_TRANSCRIPT_PROMPT = `You are a transcription normalization assistant for Hindi/English mixed speech.
...
exports.TRANSLITERATE_PROMPT = 'Transliterate the following Devanagari text to Roman/English letters. ' +
