 ...
 */
export declare function buildAndStoreInvoicePdf(invoice: Record<string, any>, customerName: string, resolvedItems: Array<Record<string, any>>, shopName: string): Promise<{
    pdfBuffer?: Buffer;
    pdfUrl?: string;
    pdfObjectKey?: string;
}>;
