...
exports.matchIndianName = matchIndianName;
 ...
 */
function buildReverseNicknameMap() {
    const reverse = {};
 ...
 */
function checkNicknameMatch(name1, name2) {
 ...
 */
function findAllMatches(query, candidates, threshold = 0.75) {
    const matches = [];
    for (const candidate of candidates) {
        const match = matchIndianName(query, candidate, threshold);
        if (match) {
