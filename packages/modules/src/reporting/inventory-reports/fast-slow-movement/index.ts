...
export interface MovementClass { productId: string; name: string; unitsSold: number; category: "fast" | "medium" | "slow" | "dead-stock"; }
export async function classifyProductMovement(
  _tenantId: string,
