...
import {
  executeTotalPendingAmount,
  executeListCustomerBalances,
  executeCheckBalance,
  executeCreateCustomer,
  executeUpdateCustomer,
  executeGetCustomerInfo,
  executeDeleteCustomerData,
} from "./customer.handler";
...
import { executeUpdateStock } from "./product.handler";
...
class BusinessEngine {
  async execute(
    ...
    try {
      logger.info(
        { intent: intent.intent, entities: intent.entities, conversationId },
        "Executing intent",
      );
      ...
      switch (intent.intent) {
        ...
        case IntentType.CREATE_INVOICE:
          return executeCreateInvoice(e, id);
        case IntentType.CONFIRM_INVOICE:
          return executeConfirmInvoice(e, id);
        case IntentType.CANCEL_INVOICE:
          return executeCancelInvoice(e, id);
        case IntentType.SHOW_PENDING_INVOICE:
          return executeShowPendingInvoice(e, id);
        case IntentType.TOGGLE_GST:
          return executeToggleGst(e, id);
        case IntentType.PROVIDE_EMAIL:
        case IntentType.SEND_INVOICE:
          return executeProvideEmail(e, id);
        case IntentType.ADD_DISCOUNT:
        ...
        case IntentType.TOTAL_PENDING_AMOUNT:
          return executeTotalPendingAmount();
        case IntentType.LIST_CUSTOMER_BALANCES:
          return executeListCustomerBalances();
        case IntentType.CHECK_BALANCE:
          return executeCheckBalance(e, id);
        case IntentType.CREATE_CUSTOMER:
          return executeCreateCustomer(e, id);
        case IntentType.UPDATE_CUSTOMER_PHONE:
        case IntentType.UPDATE_CUSTOMER:
          return executeUpdateCustomer(e, id);
        case IntentType.GET_CUSTOMER_INFO:
          return executeGetCustomerInfo(e, id);
        case IntentType.DELETE_CUSTOMER_DATA:
          return executeDeleteCustomerData(e, id);

        // ── Payment ──────────────────────────────────────────────────────────
        case IntentType.RECORD_PAYMENT:
          return executeRecordPayment(e, id);
        case IntentType.ADD_CREDIT:
          return executeAddCredit(e, id);

        // ── Reminder ─────────────────────────────────────────────────────────
        case IntentType.CREATE_REMINDER:
          return executeCreateReminder(e, id);
        case IntentType.CANCEL_REMINDER:
          return executeCancelReminder(e, id);
        case IntentType.LIST_REMINDERS:
          return executeListReminders();
        case IntentType.MODIFY_REMINDER:
          return executeModifyReminder(e, id);

        // ── Reports ──────────────────────────────────────────────────────────
        case IntentType.DAILY_SUMMARY:
          return executeDailySummary();
        case IntentType.CHECK_STOCK:
          return executeCheckStock(e);
        case IntentType.UPDATE_STOCK:
          return executeUpdateStock(e);
        case "EXPORT_GSTR1" as IntentType:
          return executeExportGstr1(e);
        case "EXPORT_PNL" as IntentType:
          return executeExportPnl(e);
