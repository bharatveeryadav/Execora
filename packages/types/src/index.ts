...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, PermissionKey[]> = {
  ...
  admin: [
    Permission.CUSTOMERS_READ,   Permission.CUSTOMERS_CREATE,
    Permission.CUSTOMERS_UPDATE, Permission.CUSTOMERS_DELETE,
    Permission.INVOICES_READ,    Permission.INVOICES_CREATE,   Permission.INVOICES_CANCEL,
    Permission.PRODUCTS_READ,    Permission.PRODUCTS_CREATE,   Permission.PRODUCTS_UPDATE,
    Permission.PAYMENTS_READ,    Permission.PAYMENTS_CREATE,
    Permission.REMINDERS_READ,   Permission.REMINDERS_CREATE,  Permission.REMINDERS_CANCEL,
...
export const PLAN_FEATURES: Record<string, string[]> = {
  free: [
    'inventory', 'customer_credit', 'reports', 'whatsapp', 'voice_recording',
  ],
  pro: [
    'inventory', 'customer_credit', 'reports', 'whatsapp', 'voice_recording',
    'batch_tracking', 'advanced_reminders', 'email', 'gst_enabled', 'loyalty',
  ],
  enterprise: [
    'inventory', 'customer_credit', 'reports', 'whatsapp', 'voice_recording',
    'batch_tracking', 'advanced_reminders', 'email', 'gst_enabled', 'loyalty',
    'gst_filing', 'variants', 'multi_conversation', 'customer_documents',
    'conversation_queue', 'sms',
  ],
};
