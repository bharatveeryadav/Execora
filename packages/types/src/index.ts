...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, PermissionKey[]> = {
	...
	viewer: [Permission.CUSTOMERS_READ, Permission.INVOICES_READ, Permission.PRODUCTS_READ, Permission.REPORTS_READ],
};
...
export const PLAN_FEATURES: Record<string, string[]> = {
	free: ['inventory', 'customer_credit', 'reports', 'whatsapp', 'voice_recording'],
	pro: [
		'inventory',
		'customer_credit',
		'reports',
