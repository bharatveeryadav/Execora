...
const Payment = () => {
  ...
  const previousBalance = selectedCustomer
    ? parseFloat(String(selectedCustomer.balance))
    : 0;
                ...
                <div className="flex items-center justify-between">
                  <div>
                    ...
                    <p className="text-xs text-muted-foreground">
                      Current Balance:{" "}
                      <span className={`font-semibold ${previousBalance > 0 ? "text-destructive" : "text-success"}`}>
            ...
            <div className="space-y-3">
              ...
              <RadioGroup value={applyTo} onValueChange={setApplyTo} className="space-y-2">
                ...
                <div className="flex items-start gap-2">
                  ...
                  <Label htmlFor="specific" className="text-sm font-normal">Specific invoice(s)</Label>
                </div>
                <div className="flex items-start gap-2">
                  <RadioGroupItem value="balance" id="balance" className="mt-0.5" />
                  <Label htmlFor="balance" className="text-sm font-normal">Against balance (reduce total due)</Label>
                </div>
              </RadioGroup>
            </div>
