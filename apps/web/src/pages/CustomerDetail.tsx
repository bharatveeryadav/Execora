...
const CustomerDetail = () => {
  ...
  const { data: ledger = [] } = useCustomerLedger(id!) as {
    data: LedgerEntry[];
  };
            ...
            <div className="flex items-center gap-2 min-w-0">
              ...
              <div className="flex shrink-0 gap-0.5">
                ...
                <Button
                  ...
                  title="New Invoice"
                  onClick={() =>
                    navigate(`/invoice/new?customerId=${customer.id}`)
                  }
                >
          ...
          {tab === "Overview" && (
            <>
              ...
              <div className="rounded-xl border bg-card p-4 space-y-2">
                ...
                {customer.landmark && (
                  <p className="text-sm">📍 {customer.landmark}</p>
                )}
                {customer.gstin && (
              ...
              <div className="rounded-xl border bg-card p-4 space-y-3">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-medium ${(commPrefs?.whatsappEnabled ?? true) ? "text-success" : "text-muted-foreground"}`}
                    >
                      {(commPrefs?.whatsappEnabled ?? true) ? "✓ On" : "Off"}
                      {commPrefs?.whatsappNumber
                        ? ` · ${commPrefs.whatsappNumber}`
                        : ""}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-medium ${commPrefs?.emailEnabled ? "text-success" : "text-muted-foreground"}`}
                    >
                      {commPrefs?.emailEnabled ? "✓ On" : "Off"}
                      {commPrefs?.emailAddress
                        ? ` · ${commPrefs.emailAddress}`
                        : ""}
                    </span>
                  </div>
                  <div className="flex items-center justify-between">
                    ...
                    <span
                      className={`text-xs font-medium ${commPrefs?.smsEnabled ? "text-success" : "text-muted-foreground"}`}
                    >
                  ...
                  {ledger.map((entry, i) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p
                          className={`shrink-0 text-sm font-semibold ${isCharge ? "text-destructive" : "text-success"}`}
                        >
                          {isCharge ? "+" : "-"}
                          {formatCurrency(
                ...
                {!deleteConfirm ? (
                  ...
                  <div className="rounded-lg border border-destructive/30 bg-destructive/5 p-3 space-y-2">
                    <p className="text-xs font-medium text-destructive">
                      ⚠️ Deleting <strong>{customer?.name}</strong> will remove
                      all their invoices, ledger entries and reminders. This
                      cannot be undone.
                    </p>
            ...
            <div className="space-y-4 py-2">
              ...
              <div className="space-y-2 rounded-lg border p-3">
                <div className="flex items-center justify-between">
                  ...
                  <Switch
                    checked={pEmailEnabled}
                    onCheckedChange={setPEmailEnabled}
                  />
                </div>
                {pEmailEnabled && (
                  <div className="space-y-1">
              ...
              <div className="flex items-center justify-between rounded-lg border p-3">
                ...
                <Switch
                  checked={pSmsEnabled}
                  onCheckedChange={setPSmsEnabled}
                />
              </div>
              ...
              <p className="text-[11px] text-muted-foreground">
                Reminders are sent email-first. If email is off or fails,
                WhatsApp is used as fallback.
              </p>
            </div>
            <DialogFooter>
              ...
              <Button
                ...
                disabled={updateCommPrefs.isPending}
              >
